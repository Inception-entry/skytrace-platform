...
当前平台版本：**1.2.2**（候选 tag `v1.2.2-rc.21`，发版说明见 `[docs/releases/v1.2.2.md](docs/releases/v1.2.2.md)`；正式 tag 仍为 `v1.2.1`，见 `[v1.2.1.md](docs/releases/v1.2.1.md)`。历史见 `[v1.2.0.md](docs/releases/v1.2.0.md)`、`[v1.1.0.md](docs/releases/v1.1.0.md)`、`[v1.0.0.md](docs/releases/v1.0.0.md)`）。
