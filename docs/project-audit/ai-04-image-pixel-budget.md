...
RB-15：真实域名 OIDC 已单独实施，见 [rb-15-oidc-public-domain.md](rb-15-oidc-public-domain.md)。Java/Node 上传见 [rb-12-java-node-upload-magic.md](rb-12-java-node-upload-magic.md)。`h2`、整栈回滚仍各自独立。
