...
RB-11 / AS-07 已单独实施，见 [rb-11-jwt-secret-failfast.md](rb-11-jwt-secret-failfast.md)。AS-06 登录/刷新限流见 [as-06-auth-rate-limit.md](as-06-auth-rate-limit.md)。family 复用、`h2`、PDF 限额仍各自独立。
