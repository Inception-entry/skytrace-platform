...
3. 图片/视频/PDF bounded read，像素/page/chunk/frame/time budget。图片/视频有界读入见 [ai-03-upload-ffmpeg-bounds.md](ai-03-upload-ffmpeg-bounds.md)；像素预算见 [ai-04-image-pixel-budget.md](ai-04-image-pixel-budget.md)；PDF 页数/超时见 [ai-01-pdf-parse-bounds.md](ai-01-pdf-parse-bounds.md)；可终止 PDF 解析见 [ai-01-pdf-killable-process.md](ai-01-pdf-killable-process.md)。
